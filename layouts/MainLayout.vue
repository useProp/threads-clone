...
<template>
  <div id="MainLayout" class="h-screen">
    <div class="w-full max-w-[500px] mx-auto">
      <div id="TopMenu" class="w-full flex items-container justify-center px-2 h-10 my-2">
    ...
    >
      <div class="flex w-full max-w-[500px] mx-auto items-center justify-around">
        <button
            ...
            class="w-full h-full"
        >
          <Icon name="material-symbols:home-outline" size="35" style="color: white"/>
        </button>
        <button
            @click="userStore.isMenuOverlay = true"
            class="w-full h-full"
        >
          <Icon class="mb-1" name="material-symbols:edit-square-outline-rounded" size="32" style="color: white"/>
        </button>
        <button
            @click="userStore.isLogoutOverlay = true"
            class="w-full h-full"
        >
          <Icon class="mb-1" name="ph:sign-out" size="32" style="color: white"/>
        </button>
      </div>
    </div>
  </div>
